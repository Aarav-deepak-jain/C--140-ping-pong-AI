...
function startGame()
{
  ...
  document.getElementById("status").innerHTML = "Game is Loading"; //Update the h3 tag which we have created inside index.html file in project 138 who has id “status” to "Game Is Loaded”.
